...
def setupData(expInfo, dataDir=None):
    ...
    if dataDir is None:
        dataDir = _thisDir
    filename = u'data/%s_%s_%s' % (expInfo['participant'], expInfo['session'], expInfo['date'])
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/shakirmshaker/Library/Mobile Documents/com~apple~CloudDocs/DTU/CognitiveScience/Project/psychopy/experiment_lastrun.py',
